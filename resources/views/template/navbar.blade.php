<nav class="navbar navbar-expand-lg navbar-light navbar-fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link mr-4" href="{{ (Auth::user() && Auth::user()->isAdmin() ? url('/course/all') : url('/course')) }}" id="learn"><strong class="navbar-hover-color">Learn</strong></a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link mr-4" href="{{ url('/category/manage') }}" id="manage"><strong class="navbar-hover-color">Manage Category</strong></a>
      </li>
      @else
      @endif
